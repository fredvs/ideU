...
const
  ...
  de_actionsmoduletext: actionsmoduleaty = (
   'ideU konfigurieren',
    'Prozess ID',
    'An Prozess anhängen',
    'Unbekannte Modulklasse für "',
    'Geerbte Komponente',
    '" kann nicht gelöscht werden.',
    'ERROR',
    'Abbruch machen.',
    'Download abgebrochen.',
    'Ausführungsfehler mit "',
    ...
    'Modul',
    'Ungültiger Name "',
    'Ungültiger Methodenname',
    'Modul nicht gefunden',
    'Methode nicht gefunden',
    'Veröffentlichte (verwaltete) Methode',
    'ist nicht vorhanden.',
    'Möchten Sie die Veranstaltung löschen?',
    'WARNUNG',
    'Methode',
    'hat verschiedene Parameter.',
    'Ein Modul ',
    '" ist bereits geöffnet.',
    'Ungelöste Referenz(en) auf',
    'Modul(e):',
    'Formdatei kann nicht gelesen werden "',
    ...
    'Schriftform',
    'Geerbte Form',
    'Möchten Sie die Einstellungen ersetzen durch',
    'Die Datei "',
    ...
    'GDB gestorben',
    'Breakpoint-Treffer',
    'Watchpoint ausgelöst',
    'Watchpoint lesen ausgelöst',
    'Zugriff auf Watchpoint ausgelöst',
    'Endschaltbereich',
    'Funktion beendet',
    ...
    'Signal empfangen',
    'Stopp-Fehler',
    'Projekt kann nicht gelesen werden',
    'Über',
    'Objektinspektor',
    'Komponentenlager',
    'Anhängeprozess',
  ...
  de_projectoptionscontext: projectoptionsconaty = (
    'Eine falsche Kodierung kann Ihre Quelldateien beschädigen.',
     'Möchten Sie die Kodierung auf setzen',
     '*** WARNUNG ***',
     'Auflegen',
     'Unterbrechen',
     'Aufhören',
     ...
     'Beendigung',
     'Stack-Fehler',
     'Kinderstatus hat sich geändert',
     'Weitermachen',
     'Stopp, nicht blockierbar',
     'Tastaturstopp',
     'Hintergrund von tty gelesen',
     'Hintergrund an tty schreiben',
     'Dringender Zustand an Steckdose',
  ...
  de_mainformtext: mainformaty = (
      ...
      'zu',
      'Möchten Sie die Formulardatei durchsuchen?',
      'WARNUNG',
      'Formular für',
      'Formdateien',
      'Rekursive Formularhierarchie für "',
      'ERROR',
      'Klassenart',
      'nicht gefunden.',
      'Projekt',
      'wird modifiziert. Speichern?',
      'Bestätigung',
      'Datei kann nicht geöffnet werden "',
      '*** Laufen ***',
      'Wird heruntergeladen',
      'Heruntergeladen',
      'Gdb-Server-Befehl starten "',
      '" Laufen.',
      'gdb-Server starten',
      'gdb-Server-Startfehler',
      'gdb-Serverstart abgebrochen.',
      'Der Befehl start gdb kann nicht ausgeführt werden.',
      'Hochladenbefehl',
      'Download Fehler***',
      ...
      'Make ***FEHLER***',
      'Gut machen.',
      'Quelle hat sich geändert, möchten Sie das Projekt neu erstellen?',
      'Fensterlayout laden',
      'Andockbereich'
          ); 
  ...
  de_stockcaption: stockcaptionaty = (
    ...
    'Themen',                                     // sc_themes
    'Verzeichnis',                                // sc_directory
    'Ohne Symbole',                               // sc_noicons
...
initialization
  registerlangconsts(langnames[la_de], @de_langnamestext, @de_mainformtext, @de_sourceformtext, @de_projectoptionscontext,
   @de_actionsmoduletext,  @de_settingstext, @de_projectoptionstext, @de_stockcaption, 
   @de_modalresulttext,  @de_modalresulttextnoshortcut, @de_textgenerator);
end.
