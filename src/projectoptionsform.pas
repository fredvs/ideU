...
uses
 mseconsts, msestockobjects, captionideu, mseforms,msefiledialogx,
 mseapplication,msegui,msestat,msestatfile,msetabs,msesimplewidgets,msetypes,
 msestrings,msedataedits,msetextedit,msegraphedits,msewidgetgrid,msegrids,
 msesplitter,msemacros,msegdbutils,msedispwidgets,msesys,mseclasses,
 ...
 mseificomp,mseificompglob,msedragglob,mserichstring,mseact,
 msecalendardatetimeedit,msegridsglob, mseeditglob;
