...
'Continue'
 ...
 uzcyr_actionsmoduletext: actionsmoduleaty = (
      'Configure MSEide',
      'Process ID',
      'Attach to process',
   ...
   uzcyr_settingstext: isettingsaty = (
    'Apply', //se_apply
  ...
  uzcyr_projectoptionstext: projectoptionsaty = (
...
initialization
 registerlangconsts(langnames[la_uzcyr],@uzcyr_settingstext, @uzcyr_projectoptionstext, @uzcyr_stockcaption,@uzcyr_modalresulttext,
