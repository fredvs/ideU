...
var
  ...
  empty: Boolean = False;
  lang_stockcaption, lang_modalresult, lang_modalresultnoshortcut, lang_settings,
  lang_actionsmodule, lang_projectoptions  : array of msestring;  
  ...
  default_projectoptionstext, default_sourceformtext, default_stockcaption,
   default_langnamestext, default_extendedtext, constvaluearray: array of msestring;
