...
uses
 ...
 msegraphedits,msestat,msemenus,msestrings,mseevent,
...
uses
 breakpointsform_mfm,msefileutils,sourceform,projectoptionsform,
 msewidgets,actionsmodule,watchpointsform,mseformatstr,msegraphutils,
 disassform;
