...
begin
  result:= askok(lang_stockcaption[ord(sc_Delete_record_question)],lang_stockcaption[ord(sc_confirmation)])
end;

function confirmcopyrecord: boolean;
begin
  result:= askok(lang_stockcaption[ord(sc_Copy_record_question)],lang_stockcaption[ord(sc_confirmation)])
end;
 ...
 try
   ...
   checked:= afiltered;
  {
   if afiltered then begin
    ...
    hint:= stockobjects.lang_stockcaption[ord(sc_filter_off];
   end
   else begin
    imagenr:= ord(stg_dbfilteron);
    hint:= stockobjects.lang_stockcaption[ord(sc_filter_on];
   end;
   if (dno_shortcuthint in foptions) and 
